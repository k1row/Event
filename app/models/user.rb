class User < ActiveRecord::Base
  before_destroy :check_all_events_finshed
  ...
  def self.find_or_create_from_auth_hash(auth_hash)
    ...
    uid = auth_hash[:uid]
    nickname = auth_hash[:info][:nickname] # Twitter ID
    image_url = auth_hash[:info][:image]   # Twitter profile img url
